		...
		connections.get( ID ).children.forEach( function ( child ) {
			...
			switch ( type ) {
				...
				case 'VectorDisplacementColor': // NOTE: Seems to be a copy of DisplacementColor
					// Legacy Phong-model FBX properties with no equivalent slot on three.js's
					// PBR materials — expected, not an error, so this doesn't need to warn.
					console.debug( 'THREE.FBXLoader: %s map has no three.js material equivalent, skipping texture.', type );
					break;
				default:
